...
st.set_page_config(page_title="Airline Prediction App",page_icon=":airplane:",layout="wide")
...
if selected == 'Data Description':
    ...
    lottie = lottieurl("https://lottie.host/304bce08-fcd6-4211-bb21-0d219bcf66ec/ghvL9pmyOK.json")

    with left_column:
        st.title("Welcome to Airline Customer Holiday Booking :airplane:")
        st.write("**Unveiling Customer Preferences and Booking Patterns in the Airline Holiday Indus**")
        ...
        st.write("1. Identifying factors influencing successful holiday bookings and improving conversion rates.")
        ...
        st.write("3. Assessing the relationship between booking lead time and customer choices.")
        st.write("4. Analyzing the popularity of various routes and flight schedules.")
        st.write("5. Investigating the influence of booking channels on customer behavior.")
        st.write("6. Predicting the likelihood of a successful holiday booking based on customer characteristics.")
